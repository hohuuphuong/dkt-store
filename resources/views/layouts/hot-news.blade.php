<div class="home-blog">
    ...
    <div class="row">
      <div class="owl-home-blog owl-home-blog-sidebar"> 
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="mua-iphone-6s-va-iphone-6s-plus-chinh-hang-o-dau" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/ip6s3f8a.png') }}" alt="Mua iPhone 6s và iPhone 6s Plus chính hãng ở đâu?" title="Mua iPhone 6s và iPhone 6s Plus chính hãng ở đâu?" class="img-responsive"> </a>
            <div class="info">
        ...
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="lg-ra-mat-loat-tv-oled-4k-tich-hop-hdr-tai-ces-2016" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/tvlg22a8.jpg') }}" alt="LG ra mắt loạt TV OLED 4K tích hợp HDR tại CES 2016" title="LG ra mắt loạt TV OLED 4K tích hợp HDR tại CES 2016" class="img-responsive"> </a>
            <div class="info">
        ...
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="msi-ra-mat-loat-may-tinh-khung-tai-ces-2016" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/1lapd47b.jpg') }}" alt="MSI ra mắt loạt máy tính "khủng" tại CES 2016" title="MSI ra mắt loạt máy tính "khủng" tại CES 2016" class="img-responsive"> </a>
            <div class="info">
        ...
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="lenovo-ra-mat-y70-touch-gia-gan-35-trieu-dong" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/llv7032.jpg') }}" alt="Lenovo ra mắt Y70 Touch giá gần 35 triệu đồng" title="Lenovo ra mắt Y70 Touch giá gần 35 triệu đồng" class="img-responsive"> </a>
            <div class="info">
        ...
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="trai-nghiem-nhanh-2-tai-dong-h-ear-moi-cua-sony" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/tainghe6d96.jpg') }}" alt="Trải nghiệm dòng tai nghe H.ear mới của Sony" title="Trải nghiệm dòng tai nghe H.ear mới của Sony" class="img-responsive"> </a>
            <div class="info">
        ...
        <!-- list hot news -->
        <div class="item">
          <div class="article"> <a href="bai-viet-mau" class="image"> <img src="{{ asset('assets/thumb/large/100/articles/reviewsbeec.jpg') }}" alt="iPhone 7 sẽ lại là một bước "cải lùi" về thiết kế của Apple" title="iPhone 7 sẽ lại là một bước "cải lùi" về thiết kế của Apple" class="img-responsive"> </a>
            <div class="info">
